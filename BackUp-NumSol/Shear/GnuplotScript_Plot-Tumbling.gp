...
XTICS = "set xtics ;\
          set xlabel 'Tumbling: {/Symbol l}_B' font 'Times-Italic,30' offset 0,-0.75"
...
@XTICS; @YTICS
set label 1 'a' @POS
splot 'Plot_ComponentA_TumblingA_1.2_TumblingB_1-3.5_Shear0-10_ThetaA_-0.75_ThetaB_-0.5_ThetaAB_1_Sigma_0.dat' with image
# --- GRAPH b
